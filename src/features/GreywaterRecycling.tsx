...
import greywaterSystem from "@/assets/greywater-system.jpg";
import filtrationProcess from "@/assets/filtration-process.jpg";
import reuseApplications from "@/assets/reuse-applications.jpg";
  ...
  return (
    <div className="container mx-auto px-6 py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
        ...
        <div>
          <img 
            ...
            alt="Greywater filtration process"
            className="w-full h-auto rounded-xl shadow-lg"
          />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        <div>
          <img 
            src={reuseApplications} 
            alt="Greywater reuse applications"
            className="w-full h-auto rounded-xl shadow-lg"
          />
        </div>
        <div className="space-y-6">
